...
import static ASimulatorSystem.CoinChange.findMinCoins;
import java.awt.*;
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    c1.s.executeUpdate("insert into bank values('"+pin+"', '"+date+"', 'Withdrawl', '"+amount+"')");
                        ...
                        int value = Integer.parseInt(amount), i;
                        int size =3;
                        int MinCount[] = findMinCoins(coins,size,value);
                        String str="";
                         for(i = 0; i < 3; i++){
             
                            str= str+coins[i]+"Taka Note= " + MinCount[i]+"\n";
                            }
                            //JOptionPane.showMessageDialog(null,"Please Collect you cash:\n "+ str);
